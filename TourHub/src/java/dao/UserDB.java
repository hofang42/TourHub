...
public class UserDB implements DatabaseInfo {
    ...
    public boolean registerUser(User user) {
        ...
        String sql = "INSERT INTO Users (username, password, firstName, lastName, phone, email, address, createdAt, userStatus, role) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public User authenticate(String email, String password) {
        String sql = "SELECT * FROM Users WHERE email = ? AND (password = ? OR password = '')"; // Handle no password for Google users
        try (Connection conn = getConnect(); PreparedStatement ps = conn.prepareStatement(sql)) {
