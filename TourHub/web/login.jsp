<<<<<<< HEAD
<%-- Document : login.jsp Created on : 3 May, 2024, 3:51:37 PM Author : HP --%>
=======
            ...
            <div class="row gy-5 justify-content-center">
              ...
              <div class="col-12 col-lg-5 d-flex align-items-center">
                <div class="d-flex gap-3 flex-column w-100">
                  <a
                    href="https://accounts.google.com/o/oauth2/auth?scope=email profile openid&redirect_uri=http://localhost:8080/Project_SWP/login&response_type=code&client_id=969957597236-ss9e1vcfd3f8p7p16joll4t4ipgubm44.apps.googleusercontent.com&approval_prompt=force"
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-10 col-xl-8">
                        ...
                        <div class="alert alert-success text-center" role="alert">
                            Change password successfully! You can login with your new password
                        </div>
                        <% } %>
