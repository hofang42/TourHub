                        ...
                        <div class="tour-header">
                            ...
                            <div class="tour-info-container-wrapper">
                                <div class="tour-info-container">
                                    <div class="tour-name">
                                        <span class="tour-title">${tour.tourName}</span>
                                    </div>
                                    ...
                                    <div class="tour-time">
                                        ...
                                        <div class="tour-duration-container">
                                            ...
                                            <span class="tour-duration">${tour.totalTime} Hours</span>
                                        </div>
                                    </div>
                                </div>                       
            ...
            <div class="content flex">
                <div class="tour-gallery">
                    <div class="image-highlight">
                        <img class="tour-img" src="${tour.tourImg.get(0)}" alt="Tour Image 1">
                    ...
                    <c:if test="${not empty tour.tourImg[1]}">
                        <div class="image-1">
                            <img class="tour-img" src="${tour.tourImg.get(1)}" alt="Tour Image 2">
                            <a href="javascript:void(0)" onclick="toggle('popup1')">
                                <div class="img-viewmore">
                                    <h3>
                                        <i class="fa-solid fa-image"></i>
                    ...
                    <c:if test="${not empty tour.tourImg[2]}">
                        <div class="image-2">
                            <img class="tour-img" src="${tour.tourImg.get(2)}" alt="Tour Image 3">
                            <a href="javascript:void(0)" onclick="toggle('popup1')">
                                <div class="img-viewmore">
                                    <h3>
                                        <i class="fa-solid fa-image"></i>
                    ...
                    <c:if test="${not empty tour.tourImg[3]}">
                        <div class="image-3">
                            <img class="tour-img" src="${tour.tourImg.get(3)}" alt="Tour Image 4">
                            <a href="javascript:void(0)" onclick="toggle('popup1')">
                                <div class="img-viewmore">
                                    <h3>
                                        <i class="fa-solid fa-image"></i>
                    ...
                    <c:if test="${not empty tour.tourImg[4]}">
                        <div class="image-4">
                            <img class="tour-img" src="${tour.tourImg.get(4)}" alt="Tour Image 5">
                            <a href="javascript:void(0)" onclick="toggle('popup1')">
                                <div class="img-viewmore">
                                    <h3>
                                        <i class="fa-solid fa-image"></i>
                    ...
                    <div class="tour-detail-left-section">
                        <div class="left-section-above">
                            <div class="average-rating">
                                <span class="average-rating-point">${tour.averageReviewRating}</span>

                                <div class="rank">
                                    <span class="rank-type">Xuất sắc</span>
                                    <br>
                                    <span class="number-rating">Từ ${tour.numberOfReview} đánh giá</span>
                                </div>
                            </div>
                        ...
                        <c:forEach items="${tourOptions}" var="option">
                            <div class="tour-option">
                                <div class="tour-option-left-section">
                                    ...
                                    <span class="refund-section">${option.dayOfWeek}</span>
                                </div>
                                <div class="tour-option-right-section">
                                    <div class="top-pick-logo">Top pick ${option.availableSlots}</div>
        ...
        <div id="popup1">
            <div id="carouselExampleIndicators" class="carousel slide">
                <div class="carousel-indicators">
                    <c:forEach var="i" begin="0" end="${fn:length(tour.tourImg) - 1}">
                ...
                <div class="carousel-inner">
                    <c:forEach var="image" items="${tour.tourImg}">
                        <div class="carousel-item ${image eq tour.tourImg[0] ? 'active' : ''}">
