  ...
  <div class="page">
    ...
    >
            ...
            <div class="rd-navbar-panel">
              ...
              <div class="rd-navbar-brand">
                <a class="brand-name" href="index.html"
                  ><img
                    class="logo-default"
                    src="assests/images/logo-default-208x46.png"
                    alt=""
                    width="208"
                    height="46" /><img
                    class="logo-inverse"
                    src="assests/images/logo-inverse-208x46.png"
                    alt=""
                    width="208"
                    height="46"
                /></a>
      ...
      <section
        ...
        style="
          background: url('assests/images/breadcrumbs-bg.jpg');
      ...
      <div class="container container-bigger">
        ...
        >
          <div class="col-md-10 col-lg-6 col-xl-5">
            ...
            <a class="button button-default-outline button-nina" href="#"
              >learn more</a
            >
          </div>
          <div class="col-md-10 col-lg-6">
            <img
              src="assests/images/about-us-1-720x459.jpg"
              alt=""
              width="720"
              height="459"
            />
        ...
        <div class="row row-50 justify-content-sm-center text-gray-light">
          <div class="col-sm-10 col-md-6 col-xl-3">
            <article class="box-minimal">
              <div class="box-minimal-header">
                <div
                  class="box-minimal-icon box-minimal-icon-lg novi-icon mdi mdi mdi-airplane"
                ></div>
          ...
          <div class="col-sm-10 col-md-6 col-xl-3">
            <article class="box-minimal">
              <div class="box-minimal-header">
                <div
                  class="box-minimal-icon box-minimal-icon-lg novi-icon mdi mdi-map"
                ></div>
          ...
          <div class="col-sm-10 col-md-6 col-xl-3">
            <article class="box-minimal">
              <div class="box-minimal-header">
                <div
                  class="box-minimal-icon box-minimal-icon-lg novi-icon mdi mdi-city"
                ></div>
          ...
          <div class="col-sm-10 col-md-6 col-xl-3">
            <article class="box-minimal">
              <div class="box-minimal-header">
                <div
                  class="box-minimal-icon box-minimal-icon-lg novi-icon mdi mdi-beach"
                ></div>
            ...
            <div class="team-classic team-classic-circle">
              <figure>
                <img
                  ...
                  src="assests/images/team-07-300x300.jpg"
                  alt=""
                  width="300"
                  height="300"
                />
              ...
              <div class="team-classic-caption">
                <h5>
                  <a class="team-classic-title" href="#">Sandra Ferguson</a>
                </h5>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="team-classic team-classic-circle">
              <figure>
                <img
                  class="rounded-circle"
                  src="assests/images/team-08-300x300.jpg"
                  alt=""
                  width="300"
                  height="300"
                />
          ...
          <div class="col-md-6 col-lg-3">
            <div class="team-classic team-classic-circle">
              <figure>
                <img
                  class="rounded-circle"
                  src="assests/images/team-09-300x300.jpg"
                  alt=""
                  width="300"
                  height="300"
                />
              ...
              <div class="team-classic-caption">
                <h5>
                  <a class="team-classic-title" href="#">Frances Watson</a>
                </h5>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="team-classic team-classic-circle">
              <figure>
                <img
                  class="rounded-circle"
                  src="assests/images/team-10-300x300.jpg"
                  alt=""
                  width="300"
                  height="300"
                />
          ...
          <div class="col-md-6 col-lg-3">
            <div class="team-classic team-classic-circle">
              <figure>
                <img
                  class="rounded-circle"
                  src="assests/images/team-12-300x300.jpg"
                  alt=""
                  width="300"
                  height="300"
                />
          ...
          <div class="col-md-6 col-lg-3">
            <div class="team-classic team-classic-circle">
              <figure>
                <img
                  class="rounded-circle"
                  src="assests/images/team-13-300x300.jpg"
                  alt=""
                  width="300"
                  height="300"
                />
              ...
              <div class="team-classic-caption">
                <h5>
                  <a class="team-classic-title" href="#">Deborah Stewart</a>
                </h5>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="team-classic team-classic-circle">
              <figure>
                <img
                  class="rounded-circle"
                  src="assests/images/team-14-300x300.jpg"
                  alt=""
                  width="300"
                  height="300"
                />
              ...
              <div class="team-classic-caption">
                <h5>
                  <a class="team-classic-title" href="#">Patrick Douglas</a>
                </h5>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="team-classic team-classic-circle">
              <figure>
                <img
                  class="rounded-circle"
                  src="assests/images/team-15-300x300.jpg"
                  alt=""
                  width="300"
                  height="300"
                />
              ...
              <div class="team-classic-caption">
                <h5>
                  <a class="team-classic-title" href="#">Ruth Marshall</a>
                </h5>
                  ...
                  <div class="unit-body">
                    ...
                    >
                      ...
                      <p>
                        ...
                        nibh venenatis. Eu lobortis elementum nibh tellus. Id eu
                        nisl nunc mi.
                      </p>
                    </div>
                  </div>
          ...
          <div class="col-sm-10 col-md-12 col-xl-4">
            <div class="row row-30">
              <div class="col-md-4 col-xl-12 wow fadeInUp" data-wow-delay=".1s">
                <img
                  src="assests/images/about-us-2-420x280.jpg"
                  alt=""
                  width="420"
                  height="280"
                />
              ...
              <div class="col-md-4 col-xl-12 wow fadeInUp" data-wow-delay=".2s">
                <img
                  src="assests/images/about-us-3-420x280.jpg"
                  alt=""
                  width="420"
                  height="280"
                />
              </div>
              <div class="col-md-4 col-xl-12 wow fadeInUp" data-wow-delay=".3s">
                <img
                  src="assests/images/about-us-4-420x280.jpg"
                  alt=""
                  width="420"
                  height="280"
                />
        ...
        <div class="row row-50" data-lightgallery="group">
          <div class="col-sm-12 col-md-6 col-lg-4">
            <a
              ...
              href="assests/images/project-1-1200x800-original.jpg"
              data-lightgallery="item"
            >
              <div class="gallery-item-image">
                <figure>
                  <img
                    src="assests/images/project-1-570x380.jpg"
                    alt=""
                    width="570"
                    height="380"
                  />
          ...
          <div class="col-sm-12 col-md-6 col-lg-4">
            <a
              class="gallery-item titled-gallery-item"
              href="assests/images/project-2-1200x800-original.jpg"
              data-lightgallery="item"
            >
              <div class="gallery-item-image">
                <figure>
                  <img
                    src="assests/images/project-2-570x380.jpg"
                    alt=""
                    width="570"
                    height="380"
                  />
          ...
          <div class="col-sm-12 col-md-6 col-lg-4">
            <a
              class="gallery-item titled-gallery-item"
              href="assests/images/project-3-1200x800-original.jpg"
              data-lightgallery="item"
            >
              <div class="gallery-item-image">
                <figure>
                  <img
                    src="assests/images/project-3-570x380.jpg"
                    alt=""
                    width="570"
                    height="380"
                  />
          ...
          <div class="col-sm-12 col-md-6 col-lg-4">
            <a
              class="gallery-item titled-gallery-item"
              href="assests/images/project-4-1200x800-original.jpg"
              data-lightgallery="item"
            >
              <div class="gallery-item-image">
                <figure>
                  <img
                    src="assests/images/project-4-570x380.jpg"
                    alt=""
                    width="570"
                    height="380"
                  />
          ...
          <div class="col-sm-12 col-md-6 col-lg-4">
            <a
              class="gallery-item titled-gallery-item"
              href="assests/images/project-5-1200x800-original.jpg"
              data-lightgallery="item"
            >
              <div class="gallery-item-image">
                <figure>
                  <img
                    src="assests/images/project-5-570x380.jpg"
                    alt=""
                    width="570"
                    height="380"
                  />
          ...
          <div class="col-sm-12 col-md-6 col-lg-4">
            <a
              class="gallery-item titled-gallery-item"
              href="assests/images/project-6-1200x800-original.jpg"
              data-lightgallery="item"
            >
              <div class="gallery-item-image">
                <figure>
                  <img
                    src="assests/images/project-6-570x380.jpg"
                    alt=""
                    width="570"
                    height="380"
                  />
    ...
    >
      <div class="container container-wide">
        <div class="box-cta-thin">
          <p class="big">
            <strong>The most affordable prices! </strong>&nbsp;<span
              >Choose your favorite destination!</span
            >&nbsp;<a class="link-bold" href="#">Order a tour! </a>
          </p>
        </div>
      </div>
    </section>
