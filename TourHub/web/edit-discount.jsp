            ...
            <div class="form-container">
                ...
                <form action="discount" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="code" name="code" value="<%= ((Discount) request.getAttribute("discount")).getCode() %>" required>
                    </div>
                    <div class="form-group">
                        <label for="quantity">Quantity:</label>
                        <input type="number" id="quantity" name="quantity" value="<%= ((Discount) request.getAttribute("discount")).getQuantity() %>" min="1" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="require" name="require" value="<%= ((Discount) request.getAttribute("discount")).getRequire() %>" required>
                    </div>
                    <div class="form-group">
